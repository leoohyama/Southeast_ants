...
mesh <- make_mesh(data_model, xy_cols = c("X", "Y"), n_knots = 20, type = "kmeans")
plot(mesh)
...
bestmodel<-dev_model_clump_beta_int
summary(bestmodel)
...
mesh <- make_mesh(data_model, xy_cols = c("X", "Y"), n_knots = 25, type = "kmeans")
plot(mesh)
