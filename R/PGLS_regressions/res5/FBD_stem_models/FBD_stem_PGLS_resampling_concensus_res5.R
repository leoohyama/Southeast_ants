...
saveRDS(pgls_data_20,"pgls_results/PGLS_datasets_resample_native/pgls_data_res5_s20_FBD_stem.rds")
saveRDS(pgls_data_25,"pgls_results/PGLS_datasets_resample_native/pgls_data_res5_s25_FBD_stem.rds")
saveRDS(pgls_data_30,"pgls_results/PGLS_datasets_resample_native/pgls_data_res5_s30_FBD_stem.rds")
...
saveRDS(resampled_20, "pgls_results/FBD_stem_resampled_20_native_concensus_res5.rds")
...
saveRDS(resampled_25, "pgls_results/FBD_stem_resampled_25_native_concensus_res5.rds")
...
saveRDS(resampled_30, "pgls_results/FBD_stem_resampled_30_native_concensus_res5.rds")



resampled_30<-readRDS("pgls_results/FBD_stem_resampled_30_native_concensus_res5.rds")
resampled_25<-readRDS("pgls_results/FBD_stem_resampled_25_native_concensus_res5.rds")
resampled_20<-readRDS("pgls_results/FBD_stem_resampled_20_native_concensus_res5.rds")
...
saveRDS(full_sense, "pgls_results/FBD_stem_resampled_native_concensus_res5_sensitivity_data.rds")
