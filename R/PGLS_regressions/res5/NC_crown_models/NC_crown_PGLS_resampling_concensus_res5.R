...
#using uber h3 to get h3 addresses for resoltution 5
all_res<-point_to_cell(intersectionsh3, res = 5, simple = FALSE)
...
saveRDS(pgls_data_20,"pgls_results/PGLS_datasets_resample_native/pgls_data_res5_s20_NC_crown.rds")
saveRDS(pgls_data_25,"pgls_results/PGLS_datasets_resample_native/pgls_data_res5_s25_NC_crown.rds")
saveRDS(pgls_data_30,"pgls_results/PGLS_datasets_resample_native/pgls_data_res5_s30_NC_crown.rds")
...
saveRDS(resampled_20, "pgls_results/NC_crown_resampled_20_native_concensus_res5.rds")
...
saveRDS(resampled_25, "pgls_results/NC_crown_resampled_25_native_concensus_res5.rds")
...
saveRDS(resampled_30, "pgls_results/NC_crown_resampled_30_native_concensus_res5.rds")



resampled_30<-readRDS("pgls_results/NC_crown_resampled_30_native_concensus_res5.rds")
resampled_25<-readRDS("pgls_results/NC_crown_resampled_25_native_concensus_res5.rds")
resampled_20<-readRDS("pgls_results/NC_crown_resampled_20_native_concensus_res5.rds")
...
saveRDS(full_sense, "pgls_results/NC_crown_resampled_native_concensus_res5_sensitivity_data.rds")
