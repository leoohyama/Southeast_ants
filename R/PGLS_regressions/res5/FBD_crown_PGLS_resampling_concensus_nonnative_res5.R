...
saveRDS(pgls_data_20,"pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res5_s20.rds")
saveRDS(pgls_data_25,"pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res5_s25.rds")
saveRDS(pgls_data_30,"pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res5_s30.rds")
...
saveRDS(resampled_20, "pgls_results/FBD_crown_resampled_20_nonnative_concensus_res5.rds")
...
saveRDS(resampled_25, "pgls_results/FBD_crown_resampled_25_nonnative_concensus_res5.rds")
...
saveRDS(resampled_30, "pgls_results/FBD_crown_resampled_30_nonnative_concensus_res5.rds")


resampled_30<-readRDS("pgls_results/FBD_crown_resampled_30_nonnative_concensus_res5.rds")
resampled_25<-readRDS("pgls_results/FBD_crown_resampled_25_nonnative_concensus_res5.rds")
resampled_20<-readRDS("pgls_results/FBD_crown_resampled_20_nonnative_concensus_res5.rds")
...
saveRDS(full_sense, "pgls_results/FBD_crown_resampled_nonnative_concensus_res5_sensitivity_data.rds")
