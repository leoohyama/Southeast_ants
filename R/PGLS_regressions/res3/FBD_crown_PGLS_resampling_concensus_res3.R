...
concensus_tree<-phytools::consensus.edges(FBD_crown)
?phytools::consensus.edges
...
#using uber h3 to get h3 addresses for resoltution 3
all_res<-point_to_cell(intersectionsh3, res = 3, simple = FALSE)
...
all_res<-all_res %>%
  filter(species %in% native_sp$SPECIES)
...
saveRDS(pgls_data_20,"pgls_results/PGLS_datasets_resample_native/pgls_data_res3_s20.rds")
saveRDS(pgls_data_25,"pgls_results/PGLS_datasets_resample_native/pgls_data_res3_s25.rds")
saveRDS(pgls_data_30,"pgls_results/PGLS_datasets_resample_native/pgls_data_res3_s30.rds")
...
saveRDS(resampled_20, "pgls_results/FBD_crown_resampled_20_native_concensus_res3.rds")
...
saveRDS(resampled_25, "pgls_results/FBD_crown_resampled_25_native_concensus_res3.rds")
...
saveRDS(resampled_30, "pgls_results/FBD_crown_resampled_30_native_concensus_res3.rds")



resampled_30<-readRDS("pgls_results/FBD_crown_resampled_30_native_concensus_res3.rds")
resampled_25<-readRDS("pgls_results/FBD_crown_resampled_25_native_concensus_res3.rds")
resampled_20<-readRDS("pgls_results/FBD_crown_resampled_20_native_concensus_res3.rds")
...
saveRDS(full_sense, "pgls_results/FBD_crown_resampled_native_concensus_res3_sensitivity_data.rds")
