...
saveRDS(pgls_data_20,"pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res3_s20_FBD_stem.rds")
saveRDS(pgls_data_25,"pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res3_s25_FBD_stem.rds")
saveRDS(pgls_data_30,"pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res3_s30_FBD_stem.rds")
...
saveRDS(resampled_20, "pgls_results/FBD_stem_resampled_20_nonnative_concensus_res3.rds")
...
saveRDS(resampled_25, "pgls_results/FBD_stem_resampled_25_nonnative_concensus_res3.rds")
...
saveRDS(resampled_30, "pgls_results/FBD_stem_resampled_30_nonnative_concensus_res3.rds")


resampled_30<-readRDS("pgls_results/FBD_stem_resampled_30_nonnative_concensus_res3.rds")
resampled_25<-readRDS("pgls_results/FBD_stem_resampled_25_nonnative_concensus_res3.rds")
resampled_20<-readRDS("pgls_results/FBD_stem_resampled_20_nonnative_concensus_res3.rds")
...
saveRDS(full_sense, "pgls_results/FBD_stem_resampled_nonnative_concensus_res3_sensitivity_data.rds")
