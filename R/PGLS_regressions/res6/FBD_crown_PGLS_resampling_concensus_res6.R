...
#using uber h3 to get h3 addresses for resoltution 6
all_res<-point_to_cell(intersectionsh3, res = 6, simple = FALSE)
...
saveRDS(pgls_data_20,"pgls_results/PGLS_datasets_resample_native/pgls_data_res6_s20.rds")
saveRDS(pgls_data_25,"pgls_results/PGLS_datasets_resample_native/pgls_data_res6_s25.rds")
saveRDS(pgls_data_30,"pgls_results/PGLS_datasets_resample_native/pgls_data_res6_s30.rds")
...
saveRDS(resampled_20, "pgls_results/FBD_crown_resampled_20_native_concensus_res6.rds")
...
saveRDS(resampled_25, "pgls_results/FBD_crown_resampled_25_native_concensus_res6.rds")
...
saveRDS(resampled_30, "pgls_results/FBD_crown_resampled_30_native_concensus_res6.rds")



resampled_30<-readRDS("pgls_results/FBD_crown_resampled_30_native_concensus_res6.rds")
resampled_25<-readRDS("pgls_results/FBD_crown_resampled_25_native_concensus_res6.rds")
resampled_20<-readRDS("pgls_results/FBD_crown_resampled_20_native_concensus_res6.rds")
...
saveRDS(full_sense, "pgls_results/FBD_crown_resampled_native_concensus_res6_sensitivity_data.rds")
