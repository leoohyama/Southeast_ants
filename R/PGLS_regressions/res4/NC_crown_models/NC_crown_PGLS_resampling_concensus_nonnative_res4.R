...
NC_stem<-read.tree("Phylo_data/Pruned_Renamed_Trees/15k_NCuniform_stem_posterior_LEO_15Nov202.tre")
...
saveRDS(pgls_data_20,"pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res4_s20_NC_crown.rds")
saveRDS(pgls_data_25,"pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res4_s25_NC_crown.rds")
saveRDS(pgls_data_30,"pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res4_s30_NC_crown.rds")
...
saveRDS(resampled_20, "pgls_results/NC_crown_resampled_20_nonnative_concensus_res4.rds")
...
saveRDS(resampled_25, "pgls_results/NC_crown_resampled_25_nonnative_concensus_res4.rds")
...
saveRDS(resampled_30, "pgls_results/NC_crown_resampled_30_nonnative_concensus_res4.rds")


resampled_30<-readRDS("pgls_results/NC_crown_resampled_30_nonnative_concensus_res4.rds")
resampled_25<-readRDS("pgls_results/NC_crown_resampled_25_nonnative_concensus_res4.rds")
resampled_20<-readRDS("pgls_results/NC_crown_resampled_20_nonnative_concensus_res4.rds")
...
saveRDS(full_sense, "pgls_results/NC_crown_resampled_nonnative_concensus_res4_sensitivity_data.rds")
