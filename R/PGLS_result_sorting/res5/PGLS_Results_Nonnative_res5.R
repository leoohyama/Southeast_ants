...
resampled1<-readRDS("pgls_results/FBD_crown_resampled_nonnative_concensus_res5.rds")

#read in the original data that you used to generate pgls results
pgls_data<-readRDS("pgls_results/PGLS_datasets_resample_nonnative/pgls_data_res5.rds")

#read in native percentage
native_perc<-readRDS("pgls_results/exotic_percentage_forpgls_res5.rds")
...
urbanhmetrics1<-readRDS("geo_data/lanscapemetrics_nonnative_lc_res5.rds")
...
saveRDS(diff_metrics, "native_nonnative_results/landscape_metrics_nonnative_res5.rds")
saveRDS(resampled2, "native_nonnative_results/nonnative_landscape_results_res5.rds")


urbanhmetrics_area<-readRDS("geo_data/lanscapemetrics_nonnative_lc_area_res5.rds")
...
urbanhmetrics_area1<-urbanhmetrics_area %>%
  ...
  rename(area = value)
saveRDS(urbanhmetrics_area1, "native_nonnative_results/area_corrected_nonnative_res5.rds")


metrics_GI<-readRDS("geo_data/lanscapemetrics_nonnative_lc_GI_res5.rds")
...
saveRDS(model_data_nonnative, "geo_data/spatial_glm_data/nonnative/model_all_res5.rds")
